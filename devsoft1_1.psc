Algoritmo sin_titulo
	...
	Definir ctrl_prod,ctrl_clien,ctrl_ventas,ctrl_gastos,ctrl_estadocuenta Como Entero
	...
	Escribir "6.Estado de cuenta Bancario"
	Leer menu	
	...
	Segun menu hacer
			...
			Segun ctrl_ventas hacer
				...
				Caso 1:
					...
					si siex_clien == Verdadero y siex_prod == Verdadero y siex_proved Entonces
						...
						find_prod_ven <- productos[ctrl_id_prod,5] //busca el precio de venta del producto dado el id
						...
						ventas[ven,6] <- find_prod_ven
						ventas[ven,7] <- ctrl_id_clien
				...
				Caso 2:
					...
					si ven > 0 Entonces
						...
						Para i <- 1 Hasta ven Con Paso 1 Hacer
							
							Escribir "ID de la venta: ",ventas[i,1]
							Escribir "Nombre del producto: ",ventas[i,2]
							Escribir "Nombre del cliente: ",ventas[i,3]
							Escribir "Nombre del proveedor: ",ventas[i,4]
							Escribir "Fecha de la venta: ",ventas[i,5]
							Escribir "Ganancia: $",ventas[i,6]
					...
					SiNo
						...
						Escribir "No hay ninguna venta registrada"
		...
		Caso 5:
			...
			Escribir "2.gastos registrados"
			Escribir "3.Salir"
			Leer ctrl_gastos
			
			Segun ctrl_gastos Hacer
				
				Caso 1:
					
					id_gastos <- id_gastos + 1
					
					Escribir "Nombre del gasto"
					Leer nombre_gasto
					...
					id_gastos_text <- ConvertirATexto(id_gastos)
					
					gastos[id_gastos,1] <- id_gastos_text
					gastos[id_gastos,2] <- nombre_gasto
					gastos[id_gastos,3] <- fecha_gasto
					gastos[id_gastos,4] <- importe
					
				Caso 2:
					
					si id_gastos > 0 Entonces
						...
						Para i <- 1 Hasta id_gastos Con Paso 1 Hacer
							
							Escribir "ID del gasto: ",gastos[i,1]
							Escribir "Nombre del gasto: ",gastos[i,2]
							Escribir "Fecha: ",gastos[i,3]
							Escribir "Importe: ",gastos[i,4]
		...
		Caso 6:
			...
			si clien > 0 Entonces
				...
				Escribir "*** Estados de cuenta de clientes ***"
				
				
				Para i <- 1 Hasta clien Con Paso 1 Hacer
					
					Escribir i,".",clientes[i,2]
					
				FinPara
				
				Leer ctrl_estadocuenta
				
				si ven > 0 Entonces
					
					find_cliente_ban <- clientes[ctrl_estadocuenta,2]
					
					Escribir ""
					
					Escribir "*** ",find_cliente_ban," Estado de cuenta ***"
					
					Escribir ""
					
					Para  i <- 1 Hasta ven Con Paso 1 Hacer
						
						id_cliente_ventas_text <- ConvertirANumero(ventas[i,7])
						find_cliente_ban <- clientes[ctrl_estadocuenta,2]
						
						si ctrl_estadocuenta == id_cliente_ventas_text Entonces
							
							Escribir "ID cliente:",id_cliente_ventas_text
							Escribir "Concepto: Compra de ",ventas[i,2]
							Escribir "Abono:",ventas[i,6]
							Escribir "Cargo:",ventas[i,6]
							Escribir "Saldo:",ventas[i,6]
							
							Escribir ""
							
							clien_estado <- Verdadero
							
						FinSi
						
					FinPara
					
					si clien_estado == Falso Entonces
						
						Escribir "No se encontraron actividades bancarias"
